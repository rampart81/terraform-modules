...
output "public_availability_zone1_subnet_id" {
  value = "${aws_default_subnet.public_availability_zone1.id}" 
}

output "public_availability_zone2_subnet_id" {
  value = "${aws_default_subnet.public_availability_zone2.id}" 
}

output "public_subnet_ids" { 
  value = [
    "${aws_default_subnet.public_availability_zone1.id}",
    "${aws_default_subnet.public_availability_zone2.id}"
  ] 
}
...
output "public_route_table_id" {
  value =  "${aws_default_vpc.vpc.default_route_table_id}"
}
